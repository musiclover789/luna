...
func TestFingerprintWin(t *testing.T) {
	//代码开始
	//这里我打算用 约定路径的方式来实现；因为他的临时环境变量无法在chromium内部多进程共享；如果采用全局环境变量来实现的话；又多线程多进程会产生冲突；
	//这里我采用临时配置文件的方式来实现，命名用当前毫秒数来做，这样我们每次客户端只取最后的配置文件，这样就无法产生问题了。
	//第一步
