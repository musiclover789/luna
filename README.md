...
6、**浏览器源代码并不提供，另外luna抗指纹浏览器授权是收费的，200每台设备，无时间限制/不同版本不同授权，并不通用。也不提供任何免费测试**


7、**如果您喜欢免费，您也可以免费获取一个授权，前提是你需要用luna完成一个相对完整的案例，并且将教程发布到csdn、知乎、等平台，链接本github网址，持续2周以上**


8、**如果有任何bug可以反馈给我，200只是授权，不包涵免费技术咨询，一切您可以自行看文档了解，如果需要技术指导单独付费**
