...
**抗指纹部分需要授权 <非付费用户，只能测试useragent 部分效果>** 联系-QQ: 80158153
...
正常使用情况下，这部分完全代码来控制,您无需关系,但是为了方便您测试luna浏览器的基础功能，可以使用手动的方式来测试。
...
[凡事您成功的使用本框架、并且在技术论坛、或者公开网站、发布本项目有价值项目、博客、推广教程等、均可用联系我获取完全免费授权（瞎写几行那种就想蒙我的 就别联系我了）]
